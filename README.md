...
### 🧠 AI Note Generation
* **Contextual Understanding** - Powered by Groq gpt-oss-120b for deep comprehension (originally LLaMA 3.3 70B, deprecated by Groq post-submission).
...
* **Groq API** - Whisper Large-v3 (Transcription) & gpt-oss-120b (Generation).
